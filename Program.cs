    ...
    {   
        ...
        // dulezity:       
         ...
         {            
            ...
            foreach (Lokace l in Lokace.SeznamVsechLokaci)
                Lokace.OdemkniLokace(l);
            VasePostava.hracovaPostava.vZdravi += 50;
            VasePostava.hracovaPostava.RekonfiguraceHPaMany();
            VasePostava.inventarPostavy.PridejPredmet(Srp_Vetešnice);
            VasePostava.inventarPostavy.PridejPredmet(Tunika_Vetešnice);
            while (true) 
            Lokace.VyberoveMenu(); 
