...
namespace DnD_Hra
{
    internal static class Tutorial
    {
        ...
        {
            List<string> moznosti = new List<string> { "Hod kostkou", "Souboj", "Pasti", "Inventář", "Obchodování", "Rasy a povolání", "Předměty", "Lokace", "Tvroba a vylepšování předmětů","Staty a co vlastně dělají", "Smrt a její efekt","Odejít z představení mechanik" };
